...
Question 1: how to halve the compute nodes?\\
Simplification 1: consolidate compute nodes which are on the same switch. This only applies to compute nodes with one port.
